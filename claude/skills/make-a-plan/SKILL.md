...
```
Files to modify:
- `claude/skills/git-commit/SKILL.md:15-45` - Add milestone commit logic
...
- `claude/skills/git-commit/SKILL.md:40-60` - Add milestone section
```
...
- `claude/skills/git-commit/SKILL.md:14-20` - Add milestone to inputs section
- `claude/skills/git-commit/SKILL.md:40-60` - Add milestone commit section with examples
Dependencies: None
...
- `claude/skills/git-commit/SKILL.md:25-35` - Add milestone input handling
- `claude/skills/git-commit/SKILL.md:85-88` - Add pre-commit bypass logic
...
3. **Begin implementation** (after issue created)
   ...
   - Use `git-commit` skill for commits (milestone commits if needed)
...
**User request:** "Add support for milestone commits in the git-commit skill"
...
**Files to modify:**
- `claude/skills/git-commit/SKILL.md:14-20` - Add milestone input handling
- `claude/skills/git-commit/SKILL.md:40-88` - Add milestone message format
...
- `claude/skills/git-commit/SKILL.md:14-20` - Add milestone to inputs section
- `claude/skills/git-commit/SKILL.md:40-60` - Add milestone message format section
Dependencies: None
...
- `claude/skills/git-commit/SKILL.md:25-35` - Add milestone input processing
- `claude/skills/git-commit/SKILL.md:85-88` - Add pre-commit bypass logic
